...
typedef struct {
	...
	// SCGD stuff
	int Epoch; int SampleId; int BPid; int K;
	double delta; double mu; double alpha; double beta; double lambda; double lambdau; double pnorm; double rnorm; double enorm; double dWnorm;  double comp;
} tLogInt;
//============================================================================================================================================
