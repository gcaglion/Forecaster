...
EXPORT void svm_learn_classification(DOC **docs, double *class, long int
		     ...
		     optimization if not NULL. Array must be of size totdoc. */
{
  ...
  if(learn_parm->compute_loo) {
	...
	optimize_to_convergence(docs,label,totdoc,totwords,learn_parm,
				...
				&maxdiff,heldout,(long)2, 0, NULL, 0, NULL);
    ...
    optimize_to_convergence(docs,label,totdoc,totwords,learn_parm,
			    ...
			    kernel_cache,&shrink_state,model,inconsistent,unlabeled,
			    a,lin,c,&timing_profile,
			    &maxdiff,(long)-1,(long)1, 0, NULL, 0, NULL);
    if(verbosity >= 1) 
      printf("done.\n");
...
EXPORT void svm_learn_regression(DOC **docs, double *value, long int totdoc,
     ...
     /* model:       Returns learning result (assumed empty before called) */
{
  ...
  iterations=optimize_to_convergence(docs,label,totdoc,totwords,learn_parm,
				     ...
				     &timing_profile,&maxdiff,(long)-1,(long)1,
					 saveMSE, itercnt, maxEpochs, MSE);
...
EXPORT void svm_learn_ranking(DOC **docs, double *rankvalue, long int totdoc,
		       long int totwords, LEARN_PARM *learn_parm, 
...
EXPORT void svm_learn_optimization(DOC **docs, double *rhs, long int
			    totdoc, long int totwords, 
			    LEARN_PARM *learn_parm, 
			    KERNEL_PARM *kernel_parm, 
			    KERNEL_CACHE *kernel_cache, MODEL *model,
...
EXPORT long optimize_to_convergence(DOC **docs, long int *label, long int totdoc,
			     long int totwords, LEARN_PARM *learn_parm, 
			     KERNEL_PARM *kernel_parm, 
			     KERNEL_CACHE *kernel_cache, 
     ...
     /* retrain: selects training mode (1=regular / 2=holdout) */
{
  ...
  for(;retrain && (!terminate) &&(iteration<maxEpochs); iteration++) {
...
EXPORT long optimize_to_convergence_sharedslack(DOC **docs, long int *label,
			     long int totdoc, 
			     long int totwords, LEARN_PARM *learn_parm, 
			     KERNEL_PARM *kernel_parm, 
			     KERNEL_CACHE *kernel_cache, 
...
EXPORT double compute_objective_function(double *a, double *lin, double *c,
...
EXPORT void clear_index(long int *index)
              /* initializes and empties index */
{
  index[0]=-1;
} 

EXPORT void add_to_index(long int *index, long int elem)
     /* initializes and empties index */
{
  register long i;
  for(i=0;index[i] != -1;i++);
...
EXPORT long compute_index(long int *binfeature, long int range, long int *index)
...
EXPORT void optimize_svm(DOC **docs, long int *label, long int *unlabeled,
...
EXPORT void compute_matrices_for_optimization(DOC **docs, long int *label,
...
EXPORT long calculate_svm_model(DOC **docs, long int *label, long int *unlabeled,
...
EXPORT long check_optimality(MODEL *model, long int *label, long int *unlabeled,
...
EXPORT long check_optimality_sharedslack(DOC **docs, MODEL *model, long int *label,
...
EXPORT void compute_shared_slacks(DOC **docs, long int *label,
			   double *a, double *lin, 
...
EXPORT long identify_inconsistent(double *a, long int *label,
...
EXPORT long identify_misclassified(double *lin, long int *label,
			    long int *unlabeled, long int totdoc, 
...
EXPORT long identify_one_misclassified(double *lin, long int *label,
				long int *unlabeled, 
...
EXPORT void update_linear_component(DOC **docs, long int *label,
...
EXPORT long incorporate_unlabeled_examples(MODEL *model, long int *label,
				    long int *inconsistent, 
				    long int *unlabeled, 
				    double *a, double *lin, 
...
EXPORT long select_next_qp_subproblem_grad(long int *label,
				    long int *unlabeled, 
				    double *a, double *lin, 
...
EXPORT long select_next_qp_subproblem_rand(long int *label,
				    long int *unlabeled, 
				    double *a, double *lin, 
				    double *c, long int totdoc, 
				    long int qp_size, 
...
EXPORT long select_next_qp_slackset(DOC **docs, long int *label,
			     double *a, double *lin, 
			     double *slack, double *alphaslack, 
			     double *c,
			     LEARN_PARM *learn_parm, 
...
EXPORT void select_top_n(double *selcrit, long int range, long int *select,
		  long int n)
{
  register long i,j;
...
EXPORT void init_shrink_state(SHRINK_STATE *shrink_state, long int totdoc,
		       long int maxhistory)
{
  long i;
...
EXPORT void shrink_state_cleanup(SHRINK_STATE *shrink_state)
{
...
EXPORT long shrink_problem(DOC **docs,
		    LEARN_PARM *learn_parm, 
		    SHRINK_STATE *shrink_state, 
		    KERNEL_PARM *kernel_parm,
		    long int *active2dnum, 
...
EXPORT void reactivate_inactive_examples(long int *label,
				  long int *unlabeled, 
				  double *a, 
				  SHRINK_STATE *shrink_state, 
				  double *lin, 
...
EXPORT void get_kernel_row(KERNEL_CACHE *kernel_cache, DOC **docs,
...
EXPORT void cache_kernel_row(KERNEL_CACHE *kernel_cache, DOC **docs,
...
EXPORT void cache_multiple_kernel_rows(KERNEL_CACHE *kernel_cache, DOC **docs,
...
EXPORT void kernel_cache_shrink(KERNEL_CACHE *kernel_cache, long int totdoc,
...
EXPORT KERNEL_CACHE *kernel_cache_init(long int totdoc, long int buffsize)
{
  long i;
  KERNEL_CACHE *kernel_cache;
...
EXPORT void kernel_cache_reset_lru(KERNEL_CACHE *kernel_cache)
{
  long maxlru=0,k;
...
EXPORT void kernel_cache_cleanup(KERNEL_CACHE *kernel_cache)
{
...
EXPORT long kernel_cache_malloc(KERNEL_CACHE *kernel_cache)
{
  long i;
...
EXPORT void kernel_cache_free(KERNEL_CACHE *kernel_cache, long int i)
{
  kernel_cache->occu[i]=0;
  kernel_cache->elems--;
}

EXPORT long kernel_cache_free_lru(KERNEL_CACHE *kernel_cache)
...
EXPORT CFLOAT *kernel_cache_clean_and_malloc(KERNEL_CACHE *kernel_cache,
				      long int docnum)
        ...
        is removed. */
{
  ...
  kernel_cache->lru[kernel_cache->index[docnum]]=kernel_cache->time; /* lru */
  return((CFLOAT *)((char*)kernel_cache->buffer
		    +(kernel_cache->activenum*sizeof(CFLOAT)*
		      kernel_cache->index[docnum])));
}

EXPORT long kernel_cache_touch(KERNEL_CACHE *kernel_cache, long int docnum)
...
EXPORT long kernel_cache_check(KERNEL_CACHE *kernel_cache, long int docnum)
     /* Is that row cached? */
{
  return(kernel_cache->index[docnum] != -1);
}
  
EXPORT long kernel_cache_space_available(KERNEL_CACHE *kernel_cache)
...
EXPORT void compute_xa_estimates(MODEL *model, long int *label,
			  long int *unlabeled, long int totdoc, 
...
EXPORT double distribute_alpha_t_greedily(long int *sv2dnum, long int svnum,
				   DOC **docs, double *a, 
				   long int docnum, 
				   long int *label, 
				   KERNEL_PARM *kernel_parm, 
...
EXPORT void estimate_transduction_quality(MODEL *model, long int *label,
				   long int *unlabeled, 
...
EXPORT double estimate_margin_vcdim(MODEL *model, double w, double R,
			     KERNEL_PARM *kernel_parm) 
...
EXPORT double estimate_sphere(MODEL *model, KERNEL_PARM *kernel_parm)
...
{                         /* length of the longest support vector. This is */
  ...
  svmWORD nullword;          /* origin of the space. */
...
EXPORT double estimate_r_delta(DOC **docs, long int totdoc, KERNEL_PARM *kernel_parm)
{
  long i;
  double maxxlen,xlen;
  DOC *nulldoc;           /* assumes that the center of the ball is at the */
...
EXPORT double estimate_r_delta_average(DOC **docs, long int totdoc,
				KERNEL_PARM *kernel_parm)
{
  long i;
  double avgxlen;
...
EXPORT double length_of_longest_document_vector(DOC **docs, long int totdoc,
					 KERNEL_PARM *kernel_parm)
{
  long i;
  double maxxlen,xlen;
...
EXPORT void write_prediction(char *predfile, MODEL *model, double *lin,
...
EXPORT void write_alphas(char *alphafile, double *a,
		  long int *label, long int totdoc)
{
  FILE *alphafl;
  long i;
