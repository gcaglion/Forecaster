...
typedef struct svector {
  svmWORD    *words;              /* The features/values in the vector by
...
EXPORT double classify_example(MODEL *, DOC *);
EXPORT double classify_example_linear(MODEL *, DOC *);
EXPORT double kernel(KERNEL_PARM *, DOC *, DOC *);
EXPORT double single_kernel(KERNEL_PARM *, SVECTOR *, SVECTOR *);
EXPORT double custom_kernel(KERNEL_PARM *, SVECTOR *, SVECTOR *);
EXPORT SVECTOR *create_svector(svmWORD *, char *, double);
EXPORT SVECTOR *copy_svector(SVECTOR *);
EXPORT void   free_svector(SVECTOR *);
EXPORT double    sprod_ss(SVECTOR *, SVECTOR *);
EXPORT SVECTOR*  sub_ss(SVECTOR *, SVECTOR *);
EXPORT SVECTOR*  add_ss(SVECTOR *, SVECTOR *);
EXPORT SVECTOR*  add_list_ss(SVECTOR *);
EXPORT void      append_svector_list(SVECTOR *a, SVECTOR *b);
EXPORT SVECTOR*  smult_s(SVECTOR *, double);
EXPORT int       featvec_eq(SVECTOR *, SVECTOR *);
EXPORT double model_length_s(MODEL *, KERNEL_PARM *);
EXPORT void   clear_vector_n(double *, long);
EXPORT void   add_vector_ns(double *, SVECTOR *, double);
EXPORT double sprod_ns(double *, SVECTOR *);
EXPORT void   add_weight_vector_to_linear_model(MODEL *);
EXPORT DOC    *create_example(long, long, long, double, SVECTOR *);
EXPORT void   free_example(DOC *, long);
EXPORT MODEL  *read_model(char *);
EXPORT MODEL  *copy_model(MODEL *);
EXPORT void   free_model(MODEL *, int);
EXPORT int   read_documents(char *, DOC ***, double **, long *, long *);
EXPORT int    parse_document(char *, svmWORD *, double *, long *, long *, double *, long *, long, char **);
EXPORT double *read_alphas(char *,long);
EXPORT int   nol_ll(char *, long *, long *, long *);
EXPORT long   minl(long, long);
